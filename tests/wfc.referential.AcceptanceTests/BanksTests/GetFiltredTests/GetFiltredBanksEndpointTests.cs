...
public class GetFiltredBanksAcceptanceTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task GetFiltredBanks_Should_FilterByBankCode_WhenCodeProvided()
    {
        // Arrange
    ...
    public async Task GetFiltredBanks_Should_FilterByBankName_WhenNameProvided()
    {
        // Arrange
        var filteredBanks = new List<Bank>
        {
    ...
    public async Task GetFiltredBanks_Should_FilterByIsEnabled_WhenStatusProvided()
    {
        // Arrange
    ...
    public async Task GetFiltredBanks_Should_ReturnPaginatedResults_WhenPaginationParametersProvided()
    {
        // Arrange
        var banks = new List<Bank>
        {
    ...
    public async Task GetFiltredBanks_Should_ReturnEmptyResult_WhenNoMatchesFound()
    {
        // Arrange
    ...
    public async Task GetFiltredBanks_Should_SupportMultipleCriteria_WhenMultipleFiltersProvided()
    {
        // Arrange
        var filteredBanks = new List<Bank>
        {
    ...
    public async Task GetFiltredBanks_Should_SupportVariousSearchCriteria(string filterType, string filterValue)
    {
        // Arrange
        var banks = new List<Bank>
        {
    ...
    public async Task GetFiltredBanks_Should_ReturnAllBankData_InResponse()
    {
        // Arrange
        var banks = new List<Bank>
        {
