...
public class GetAllCurrenciesAcceptanceTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;
    private readonly Mock<ICurrencyRepository> _repoMock = new();

    public GetAllCurrenciesAcceptanceTests(WebApplicationFactory<Program> factory)
    {
    ...
    public async Task GetAllCurrencies_Should_ReturnAllCurrencies_UsingSearchCriteria()
    {
        // Arrange
    ...
    public async Task GetAllCurrencies_Should_FilterByCurrencyCode_WhenCodeProvided()
    {
        // Arrange
    ...
    public async Task GetAllCurrencies_Should_FilterByCurrencyName_WhenNameProvided()
    {
        // Arrange
        var filteredCurrencies = new List<Currency>
        {
    ...
    public async Task GetAllCurrencies_Should_FilterByIsEnabled_WhenStatusProvided()
    {
        // Arrange
    ...
    public async Task GetAllCurrencies_Should_ReturnPaginatedResults_WhenPaginationParametersProvided()
    {
        // Arrange
        var currencies = new List<Currency>
        {
    ...
    public async Task GetAllCurrencies_Should_ReturnEmptyResult_WhenNoMatchesFound()
    {
        // Arrange
    ...
    public async Task GetAllCurrencies_Should_SupportMultipleCriteria_WhenMultipleFiltersProvided()
    {
        // Arrange
        var filteredCurrencies = new List<Currency>
        {
    ...
    public async Task GetAllCurrencies_Should_SupportVariousSearchCriteria(string filterType, string filterValue)
    {
        // Arrange
        var currencies = new List<Currency>
        {
    ...
    public async Task GetAllCurrencies_Should_ReturnAllCurrencyData_InResponse()
    {
        // Arrange
        var currencies = new List<Currency>
        {
