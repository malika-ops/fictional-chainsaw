...
public class UpdateContractEndpointTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public UpdateContractEndpointTests(WebApplicationFactory<Program> factory)
    {
