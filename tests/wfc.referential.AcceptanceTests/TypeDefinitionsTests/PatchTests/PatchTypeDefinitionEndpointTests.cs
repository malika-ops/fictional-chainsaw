...
public class PatchTypeDefinitionEndpointTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Patch_ShouldReturn200_AndPatchOnlyProvidedFields()
    {
        ...
        var payload = new
        {
            TypeDefinitionId = id,
            Libelle = "New Libelle"
            // Description intentionally omitted - should not change
        };
        ...
        updated.Description.Should().Be("Old Description");  // Description should not change
    ...
    public async Task Patch_ShouldReturn200_WhenUpdatingEnabledStatus()
    {
        ...
        updated.Libelle.Should().Be("Test Libelle");  // Other fields remain unchanged
