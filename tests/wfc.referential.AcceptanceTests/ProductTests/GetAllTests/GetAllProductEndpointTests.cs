...
namespace wfc.referential.AcceptanceTests.ProductTests.GetAllTests;

public class GetAllProductEndpointTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;
    private readonly Mock<IProductRepository> _repoMock = new();

    public GetAllProductEndpointTests(WebApplicationFactory<Program> factory)
    {
