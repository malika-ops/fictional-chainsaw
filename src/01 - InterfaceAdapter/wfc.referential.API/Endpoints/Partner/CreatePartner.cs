...
public class CreatePartner(IMediator _mediator) : Endpoint<CreatePartnerRequest, Guid>
{
    public override void Configure()
    {
        ...
        Summary(s =>
        {
            ...
            s.Description = "Creates a partner with code, label, network mode, payment mode, identification details, and other relevant information.";
    ...
    public override async Task HandleAsync(CreatePartnerRequest dto, CancellationToken ct)
    {
        var command = dto.Adapt<CreatePartnerCommand>();
