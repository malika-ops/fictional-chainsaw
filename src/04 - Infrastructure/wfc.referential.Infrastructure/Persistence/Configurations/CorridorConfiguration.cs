...
public class CorridorConfiguration : IEntityTypeConfiguration<Corridor>
{
    public void Configure(EntityTypeBuilder<Corridor> builder)
    {
        ...
        builder.Property(x => x.Id)
            .HasConversion(id => id.Value, value => new CorridorId(value));

        builder.Property(x => x.SourceCountryId).HasConversion(id => id.Value, value => new CountryId(value));
        builder.Property(x => x.DestinationCountryId).HasConversion(id => id.Value, value => new CountryId(value));

        builder.Property(x => x.SourceCityId).HasConversion(id => id.Value, value => new CityId(value));
        builder.Property(x => x.DestinationCityId).HasConversion(id => id.Value, value => new CityId(value));

        builder.Property(x => x.SourceAgencyId).HasConversion(id => id.Value, value => new AgencyId(value));
        builder.Property(x => x.DestinationAgencyId).HasConversion(id => id.Value, value => new AgencyId(value));
