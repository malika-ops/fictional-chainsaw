...
public class ParamTypeRepository : IParamTypeRepository
{
    ...
    public async Task<ParamType?> GetByValueAsync(string value, CancellationToken cancellationToken)
    {
        return await _context.ParamTypes
       .Where(pt => pt.Value == value)
       .FirstOrDefaultAsync(cancellationToken);
    }
    ...
    public Task UpdateParamTypeAsync(ParamType paramtype, CancellationToken cancellationToken)
    {
        _context.ParamTypes.Update(paramtype);
        return Task.CompletedTask;
    }

    public Task DeleteParamTypeAsync(ParamType paramtype, CancellationToken cancellationToken)
    {
