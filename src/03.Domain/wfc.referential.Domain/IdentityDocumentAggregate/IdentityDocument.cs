...
public class IdentityDocument : Aggregate<IdentityDocumentId>
{
    ...
    public IdentityDocument(IdentityDocumentId id, string code, string name, string? description, bool isEnabled)
    {
        Id = id;
        Code = code;
        Name = name;
    ...
    public static IdentityDocument Create(IdentityDocumentId id, string code, string name, string? description, bool isEnabled)
    {
        var entity = new IdentityDocument(id, code, name, description, isEnabled);
