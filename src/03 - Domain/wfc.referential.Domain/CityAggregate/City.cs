...
public class City : Aggregate<CityId>
{
    ...
    public string TaxZone { get; private set; } = default!;
    public bool IsEnabled { get; private set; } = true;
    public List<Sector> Sectors { get; set; } = [];

    private City() { }
    public static City Create(CityId id, string cityCode, string cityName, string timeZone, string taxZone, RegionId regionId, string abbreviation)
    {
        var city = new City
        {
            Id = id,
    ...
    public void Update(string cityCode, string cityName, string abbreviation, string timeZone, string taxZone, RegionId regionId)
    {
        Code = cityCode;
        Name = cityName;
        TimeZone = timeZone;
