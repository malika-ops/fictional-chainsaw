...
public class CreateMonetaryZoneCommandHandler : ICommandHandler<CreateMonetaryZoneCommand, Result<Guid>>
{
    private readonly IMonetaryZoneRepository _monetaryZoneRepository;

    public CreateMonetaryZoneCommandHandler(IMonetaryZoneRepository monetaryZoneRepository)
    {
